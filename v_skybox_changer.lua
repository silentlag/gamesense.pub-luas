-- fixed skybox changer since it had crirical bugs like huge drop fps with color changing (made by @silentlag)
...
local find_is_directory =
    Patterns("filesystem_stdio.dll", "VFileSystem017", "\x55\x8B\xEC\x0F\xB7\x45\x08", "bool(__thiscall*)(void*, int)")
...
local load_name_sky_address =
    client.find_signature("engine.dll", "\x55\x8B\xEC\x81\xEC\xCC\xCC\xCC\xCC\x56\x57\x8B\xF9\xC7\x45") or
...
ui.set_callback(skybox_color_checkbox, SkyboxColor)
ui.set_callback(skybox_color, SkyboxColor)
